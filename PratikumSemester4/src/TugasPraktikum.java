 ...
 * @author RizkyKiwa
 */
public class TugasPraktikum extends javax.swing.JFrame {
...
if (pilihan6.isSelected()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TugasPraktikum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TugasPraktikum().setVisible(true);
            }
        });
    }
